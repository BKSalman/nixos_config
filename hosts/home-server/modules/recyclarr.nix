{config, ...}: {
  services.recyclarr = {
    enable = true;
    schedule = "weekly"; # Adjust as needed: daily, weekly, *-*-* 03:00:00, etc.
      ...
      sonarr = {
        anime = {
          ...
          custom_format_groups = {
            ################################################################################
            ## These groups are NOT synced by default. Uncomment to enable. Use `select:`
            ## to choose specific CFs within a group.
            ##

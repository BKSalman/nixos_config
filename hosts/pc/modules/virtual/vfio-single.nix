  ...
  environment.etc = {
    ...
    "libvirt/hooks/qemu.d/win10/prepare/begin/start.sh" = {
      text = ''
        ...
        # Debugging
        # exec 19>/home/salman/Desktop/startlogfile
        # BASH_XTRACEFD=19
        # set -x
        ...
        # Logout
        source /home/salman/.local/bin/./logout.sh
    ...
    "libvirt/hooks/qemu.d/win10/release/end/stop.sh" = {
      text = ''
        ...
        # Debugging
        # exec 19>/home/salman/Desktop/stoplogfile
        # BASH_XTRACEFD=19
        # set -x
    ...
    # "libvirt/vgabios/patched.rom".source = /home/salman/Desktop/Sync/Files/Linux_Config/symlinks/patched.rom;
  };
}
